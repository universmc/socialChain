...
const subject = process.argv[2] || `Dans le contexte d'une enquête parlementaire, le témoin clé est généralement une personne qui a une connaissance directe ou une expérience significative en relation avec le sujet de l'enquête. Il s'agit d'un individu dont le témoignage peut être crucial pour éclairer les parlementaires sur les questions en suspens et pour aider à établir les faits.
Le témoin clé peut être un membre du gouvernement, un expert dans le domaine concerné, un représentant d'une organisation ou d'une entreprise impliquée, ou toute autre personne ayant des informations pertinentes à partager avec la commission d'enquête.
En identifiant et en entendant ce témoin clé, la commission d'enquête parlementaire peut progresser dans son investigation et établir un rapport plus complet et plus précis sur le sujet étudié. `;
